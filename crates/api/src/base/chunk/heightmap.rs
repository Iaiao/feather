...
use crate::blocks::{BlockId, SimplifiedBlockKind};

use super::PackedArray;
use crate::base::chunk::{CHUNK_WIDTH, SECTION_WIDTH};
    ...
    pub fn new(height: WorldHeight) -> Self {
        Self {
            heights: PackedArray::new(
                ...
                NonZeroUsize::new((*height as f64 + 1.0).log2().ceil() as usize).unwrap(),
            ),
            height,
            _marker: PhantomData,
        }
