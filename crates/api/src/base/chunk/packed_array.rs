...
impl PackedArray {
    ...
    pub fn from_u64_vec(bits: Vec<u64>, length: usize) -> Self {
        ...
        let bits_per_value = NonZeroUsize::new(bits.len() * u64::BITS as usize / length).unwrap();
        Self {
            length,
            bits_per_value,
            bits,
    ...
    fn indexes(&self, index: usize) -> (usize, usize) {
        let (u64_index, index) = index.div_rem(&self.values_per_u64());
...
mod tests {
    ...
    fn smoke() {
        let length = 100;
        let mut array = PackedArray::new(length, NonZeroUsize::new(10).unwrap());
    ...
    #[test]
    fn out_of_bounds() {
        let array = PackedArray::new(97, NonZeroUsize::new(10).unwrap());
        assert_eq!(array.bits.len(), 17);
    ...
    #[test]
    fn iter() {
        let mut array = PackedArray::new(10_000, NonZeroUsize::new(10).unwrap());
    ...
    fn resize() {
        ...
        let length = 1024;
        let mut array = PackedArray::new(length, NonZeroUsize::new(1).unwrap());
        ...
        for new_bits_per_value in 2..=16 {
            ...
            array = array.resized(NonZeroUsize::new(new_bits_per_value).unwrap());
    ...
    #[test]
    fn fill() {
        let mut array = PackedArray::new(1024, NonZeroUsize::new(10).unwrap());
        array.fill(102);
    ...
    #[should_panic]
    fn fill_too_large() {
        let mut array = PackedArray::new(100, NonZeroUsize::new(10).unwrap());
