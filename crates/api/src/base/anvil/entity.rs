use crate::common::positions::{vec3, Position, Vec3d};
...
mod tests {
    ...
    fn test_read_position() {
        ...
        assert!(pos.x - 1.0 < f64::EPSILON);
        assert!(pos.y - 2.0 < f64::EPSILON);
        assert!(pos.z - 3.0 < f64::EPSILON);
        assert!(pos.yaw - 4.0 < f32::EPSILON);
        assert!(pos.pitch - 5.0 < f32::EPSILON);
    }
