...
use crate::base::world::DimensionTypeInfo;
use crate::components::{PreviousGamemode, ProfileProperty};
use crate::protocol::{io::VarLong, ProtocolVersion, Readable, Writeable};
use crate::BiomeInfo;
...
packets! {
    ...
    SculkVibrationSignal {
        source_position NetworkBlockPosition;
