...
pub const HIGHEST_ID: usize = 20341;

static FROM_VANILLA_ID_TABLE: Lazy<Vec<BlockId>> = Lazy::new(|| {
    let mut res = vec![BlockId::default(); u16::MAX as usize];
...
pub use generated::table::*;

use generated::table::BlockTable;
...
impl BlockId {
    ...
    */
    ...
    #[inline]
    pub fn from_vanilla_id(id: u16) -> Option<Self> {
        FROM_VANILLA_ID_TABLE.get(id as usize).copied()
    }
}
