...
pub fn generate() {
    ...
    output_bytes(
        "crates/api/src/blocks/generated/table.dat",
    ...
    output_bytes(
        "crates/api/src/blocks/generated/vanilla_ids.dat",
        bincode::serialize(&VanillaStateIdSerialize::new(&blocks)).unwrap(),
    );

    output(
        "crates/api/src/blocks/generated/table.rs",
        table_src.to_string().as_str(),
    );
    output(
        "crates/api/src/blocks/generated/properties.rs",
        properties_src.to_string().as_str(),
    );
    output(
        "crates/api/src/blocks/generated/block_fns.rs",
...
fn load() -> Blocks {
    let mut report = serde_json::from_str(
        &std::fs::read_to_string(format!("build/generated/reports/blocks.json")).unwrap(),
    )
    .unwrap();
